...
public class Vehicle implements Comparable<Vehicle>, Serializable {
    ...
    public Vehicle(String brand, String model, itemCondition condition, double price, int year_of_production, double mileage, double engine_capacity, int amount, int phoneNumber, String fuel) {
        this.brand = brand;
        this.model = model;
